...
@Slf4j
@Order(62)
public class Case062Runner implements CommandLineRunner, ApplicationContextAware {
    ...
    public void run(String... args) {
        String proxyType = detectProxyType(applicationContext, "062");
        log.info("case result: {},{},{}",
                ...
                detectEffectiveness(applicationContext, "062"),
                proxyType);
    }
}
