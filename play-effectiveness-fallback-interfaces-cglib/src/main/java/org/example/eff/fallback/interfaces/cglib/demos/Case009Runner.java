...
@Slf4j
@Order(9)
public class Case009Runner implements CommandLineRunner, ApplicationContextAware {
    ...
    public void run(String... args) {
        String proxyType = detectProxyType(applicationContext, "009");
        log.info("case result: {},{},{}",
                ...
                detectEffectiveness(applicationContext, "009"),
                proxyType);
    }
}
