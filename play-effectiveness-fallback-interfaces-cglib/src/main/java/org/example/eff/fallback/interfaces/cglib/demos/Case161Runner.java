...
@Slf4j
@Order(161)
public class Case161Runner implements CommandLineRunner, ApplicationContextAware {
    ...
    public void run(String... args) {
        String proxyType = detectProxyType(applicationContext, "161");
        log.info("case result: {},{},{}",
                ...
                detectEffectiveness(applicationContext, "161"),
                proxyType);
    }
}
