...
@Slf4j
@Order(42)
public class Case042Runner implements CommandLineRunner, ApplicationContextAware {
    ...
    public void run(String... args) {
        String proxyType = detectProxyType(applicationContext, "042");
        log.info("case result: {},{},{}",
                ...
                detectEffectiveness(applicationContext, "042"),
                proxyType);
    }
}
