...
@Slf4j
@Order(94)
public class Case094Runner implements CommandLineRunner, ApplicationContextAware {
    ...
    public void run(String... args) {
        String proxyType = detectProxyType(applicationContext, "094");
        log.info("case result: {},{},{}",
                ...
                detectEffectiveness(applicationContext, "094"),
                proxyType);
    }
}
