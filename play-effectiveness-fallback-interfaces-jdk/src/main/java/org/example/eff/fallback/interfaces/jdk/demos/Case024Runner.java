...
@Slf4j
@Order(24)
public class Case024Runner implements CommandLineRunner, ApplicationContextAware {
    ...
    public void run(String... args) {
        String proxyType = detectProxyType(applicationContext, "024");
        log.info("case result: {},{},{}",
                ...
                detectEffectiveness(applicationContext, "024"),
                proxyType);
    }
}
