...
@Slf4j
@Order(87)
public class Case087Runner implements CommandLineRunner, ApplicationContextAware {
    ...
    public void run(String... args) {
        String proxyType = detectProxyType(applicationContext, "087");
        log.info("case result: {},{},{}",
                ...
                detectEffectiveness(applicationContext, "087"),
                proxyType);
    }
}
