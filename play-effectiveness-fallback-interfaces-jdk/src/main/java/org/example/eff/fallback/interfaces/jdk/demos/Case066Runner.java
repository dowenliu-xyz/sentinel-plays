...
@Slf4j
@Order(66)
public class Case066Runner implements CommandLineRunner, ApplicationContextAware {
    ...
    public void run(String... args) {
        String proxyType = detectProxyType(applicationContext, "066");
        log.info("case result: {},{},{}",
                ...
                detectEffectiveness(applicationContext, "066"),
                proxyType);
    }
}
