...
public class SingleRunner implements CommandLineRunner {
    ...
    public void run(String... args) {
        // 类注解 + 方法注解。方法注解生效
        expectFallback(singleWithClassAnnoWithMethodAnnoJavaDemo::greeting);
        expectFallback(singleWithClassAnnoWithMethodAnnoKotlinDemo::greeting);
         // 仅有类注解，类注解不生效
        ...
        // 仅有方法注解，方法注解生效
        expectFallback(singleWithoutClassAnnoWithMethodAnnoJavaDemo::greeting);
        expectFallback(singleWithoutClassAnnoWithMethodAnnoKotlinDemo::greeting);
    }
}
