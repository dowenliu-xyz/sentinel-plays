...
@Slf4j
@Order(59)
public class Case059Runner implements CommandLineRunner, ApplicationContextAware {
    ...
    public void run(String... args) {
        String proxyType = detectProxyType(applicationContext, "059");
        log.info("case result: {},{},{}",
                ...
                detectEffectiveness(applicationContext, "059"),
                proxyType);
    }
}
