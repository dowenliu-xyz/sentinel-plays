...
@Slf4j
@Order(101)
public class Case101Runner implements CommandLineRunner, ApplicationContextAware {
    ...
    public void run(String... args) {
        String proxyType = detectProxyType(applicationContext, "101");
        log.info("case result: {},{},{}",
                ...
                detectEffectiveness(applicationContext, "101"),
                proxyType);
    }
}
