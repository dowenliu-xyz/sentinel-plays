...
public class ProtectedMethodWithClassAnnoWithMethodAnnoNoAttrJavaDemo {
    private ProtectedMethodWithClassAnnoWithMethodAnnoNoAttrJavaDemo self;

    @Autowired
    public void setSelf(ProtectedMethodWithClassAnnoWithMethodAnnoNoAttrJavaDemo self) {
        this.self = self;
    }
