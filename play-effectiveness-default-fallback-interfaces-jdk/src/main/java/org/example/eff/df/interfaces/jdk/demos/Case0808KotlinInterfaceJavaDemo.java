...
/**
 * Case: Case(sn=0808, classAnnoOnSuper=None, originMethodInSuper=WithAnnoNoAttrAbstract, handlerInSuper=WithBody, classAnnoOnClass=None, originMethodInClass=WithAnnoHavingAttr, hasHandlerInClass=true)
 */
@SuppressWarnings("unused")
@Component
public class Case0808KotlinInterfaceJavaDemo implements Case0808KotlinInterfaceForJava {
