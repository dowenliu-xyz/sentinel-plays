...
@Slf4j
@Order(53)
public class Case053Runner implements CommandLineRunner, ApplicationContextAware {
    ...
    public void run(String... args) {
        String proxyType = detectProxyType(applicationContext, "053");
        log.info("case result: {},{},{}",
                ...
                detectEffectiveness(applicationContext, "053"),
                proxyType);
    }
}
