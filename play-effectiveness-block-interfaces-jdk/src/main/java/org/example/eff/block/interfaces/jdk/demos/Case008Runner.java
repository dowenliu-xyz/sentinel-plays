...
@Slf4j
@Order(8)
public class Case008Runner implements CommandLineRunner, ApplicationContextAware {
    ...
    public void run(String... args) {
        String proxyType = detectProxyType(applicationContext, "008");
        log.info("case result: {},{},{}",
                ...
                detectEffectiveness(applicationContext, "008"),
                proxyType);
    }
}
