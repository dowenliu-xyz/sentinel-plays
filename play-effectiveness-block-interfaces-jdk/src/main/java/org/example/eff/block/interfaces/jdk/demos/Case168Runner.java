...
@Slf4j
@Order(168)
public class Case168Runner implements CommandLineRunner, ApplicationContextAware {
    ...
    public void run(String... args) {
        String proxyType = detectProxyType(applicationContext, "168");
        log.info("case result: {},{},{}",
                ...
                detectEffectiveness(applicationContext, "168"),
                proxyType);
    }
}
