...
@Slf4j
@Order(173)
public class Case173Runner implements CommandLineRunner, ApplicationContextAware {
    ...
    public void run(String... args) {
        String proxyType = detectProxyType(applicationContext, "173");
        log.info("case result: {},{},{}",
                ...
                detectEffectiveness(applicationContext, "173"),
                proxyType);
    }
}
