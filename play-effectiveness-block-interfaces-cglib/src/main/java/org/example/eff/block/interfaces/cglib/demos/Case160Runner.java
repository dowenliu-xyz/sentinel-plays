...
@Slf4j
@Order(160)
public class Case160Runner implements CommandLineRunner, ApplicationContextAware {
    ...
    public void run(String... args) {
        String proxyType = detectProxyType(applicationContext, "160");
        log.info("case result: {},{},{}",
                ...
                detectEffectiveness(applicationContext, "160"),
                proxyType);
    }
}
